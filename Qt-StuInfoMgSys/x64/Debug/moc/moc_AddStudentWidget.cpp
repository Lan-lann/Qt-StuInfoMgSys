...
struct qt_meta_stringdata_CLASSAddStudentWidgetENDCLASS_t {};
constexpr auto qt_meta_stringdata_CLASSAddStudentWidgetENDCLASS = QtMocHelpers::stringData(
    "AddStudentWidget"
);
...
Q_CONSTINIT static const uint qt_meta_data_CLASSAddStudentWidgetENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject AddStudentWidget::staticMetaObject = { {
    ...
    qt_meta_stringdata_CLASSAddStudentWidgetENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSAddStudentWidgetENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSAddStudentWidgetENDCLASS_t,
        // Q_OBJECT / Q_GADGET
...
void *AddStudentWidget::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CLASSAddStudentWidgetENDCLASS.stringdata0))
